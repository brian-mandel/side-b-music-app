        ...
        <div className="flex items-center gap-2">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="max-h-60 overflow-y-auto">
              ...
              <DropdownMenuSeparator />
              <DropdownMenuCheckboxItem
                checked={artistFilter === null}
                onCheckedChange={() => setArtistFilter(null)}
              >
                All Artists
              </DropdownMenuCheckboxItem>
              {uniqueArtists.map((artist) => (
                <DropdownMenuCheckboxItem
                  key={artist}
                  checked={artistFilter === artist}
                  onCheckedChange={() => setArtistFilter(artist)}
                >
                  {artist}
                </DropdownMenuCheckboxItem>
              ))}
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuCheckboxItem
                ...
                onCheckedChange={() => setRatingFilter(null)}
              >
                All Ratings
              </DropdownMenuCheckboxItem>
